...
// $image->upload($db);
// $user = new User("john_doe", "john@gmail.com", "John Doe", "password", time(), $image, "seller");
// $user->upload($db);
...
print("seller: {$item->seller->name}\n");
print("size: {$item->size->size}\n");
print("category: {$item->category->category}\n");
print("condition: {$item->condition->condition}\n");
